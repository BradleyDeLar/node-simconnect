...
// std::map<SIMCONNECT_TEXT_TYPE, const char*> textTypes = {
...
// 	{ SIMCONNECT_TEXT_TYPE_SCROLL_GREEN, "SIMCONNECT_TEXT_TYPE_SCROLL_GREEN" },
// 	{ SIMCONNECT_TEXT_TYPE_SCROLL_BLUE, "SIMCONNECT_TEXT_TYPE_SCROLL_BLUE" },
// 	{ SIMCONNECT_TEXT_TYPE_SCROLL_YELLOW, "SIMCONNECT_TEXT_TYPE_SCROLL_YELLOW" },
// 	{ SIMCONNECT_TEXT_TYPE_SCROLL_MAGENTA, "SIMCONNECT_TEXT_TYPE_SCROLL_MAGENTA" },
// 	{ SIMCONNECT_TEXT_TYPE_SCROLL_CYAN, "SIMCONNECT_TEXT_TYPE_SCROLL_CYAN" },
// 	{ SIMCONNECT_TEXT_TYPE_PRINT_BLACK, "SIMCONNECT_TEXT_TYPE_PRINT_BLACK" },
// 	{ SIMCONNECT_TEXT_TYPE_PRINT_WHITE, "SIMCONNECT_TEXT_TYPE_PRINT_WHITE" },
// 	{ SIMCONNECT_TEXT_TYPE_PRINT_RED, "SIMCONNECT_TEXT_TYPE_PRINT_RED" },
// 	{ SIMCONNECT_TEXT_TYPE_PRINT_GREEN, "SIMCONNECT_TEXT_TYPE_PRINT_GREEN" },
// 	{ SIMCONNECT_TEXT_TYPE_PRINT_BLUE, "SIMCONNECT_TEXT_TYPE_PRINT_BLUE" },
// 	{ SIMCONNECT_TEXT_TYPE_PRINT_YELLOW, "SIMCONNECT_TEXT_TYPE_PRINT_YELLOW" },
// 	{ SIMCONNECT_TEXT_TYPE_PRINT_MAGENTA, "SIMCONNECT_TEXT_TYPE_PRINT_MAGENTA" },
// 	{ SIMCONNECT_TEXT_TYPE_PRINT_CYAN, "SIMCONNECT_TEXT_TYPE_PRINT_CYAN" },
// 	{ SIMCONNECT_TEXT_TYPE_MENU, "SIMCONNECT_TEXT_TYPE_MENU" },
// 	{ SIMCONNECT_TEXT_TYPE_MESSAGE_WINDOW, "SIMCONNECT_TEXT_TYPE_MESSAGE_WINDOW" }
// };
